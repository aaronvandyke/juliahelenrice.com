...
// const studentSlideData = document.querySelectorAll('.studentSlideHref');
...
// const studentSlides = Array.from(document.querySelectorAll('.student-slides'));
// const studentSlideTotal = studentSlides.length;
...
// ***** Get relative href's for student images *****
// let studentSlideHrefs = [];
// for(let i = 0; i < studentSlideData.length; i++) {
//   studentSlideHrefs.push(studentSlideData[i].getAttribute('href'));
// }
...
function moveToNextSlide() {
  ...
  currentSlide.onload = function() {setTimeout(fadeIn, 200);};
}
